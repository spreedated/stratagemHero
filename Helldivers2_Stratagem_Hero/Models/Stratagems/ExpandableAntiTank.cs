...
{
    public sealed record ExpandableAntiTank : Stratagem
    {
        public ExpandableAntiTank()
        {
            base.Name = "EAT-17 Expandable Anti-tank";
            base.Category = Categories.SBackpack;
            base.Icon = LoadEmbeddedStratagem("EAT-17icon");
