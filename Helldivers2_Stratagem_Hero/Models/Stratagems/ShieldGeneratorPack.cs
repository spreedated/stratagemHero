...
{
    public sealed record ShieldGeneratorPack : Stratagem
    {
        public ShieldGeneratorPack()
        {
            base.Name = "SH-20 Shield Generator Pack";
            base.Category = Categories.SBackpack;
            base.Icon = LoadEmbeddedStratagem("SH-32icon");
